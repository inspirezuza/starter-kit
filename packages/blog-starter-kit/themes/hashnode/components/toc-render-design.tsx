		...
		<li key={node.id} className="px-2 py-0.5 align-middle">
			...
			>
				...
				<a
					id={node.id}
					className={twJoin(
						'w-full py-2.5 pr-2.5 text-lg font-bold text-slate-800 dark:text-slate-100',
	...
	return (
		...
		>
			<div className={tocFullVisibility ? 'max-h-full' : 'max-h-[388px] overflow-hidden'}>
				...
				{modal || (
					<div className="pt-4">
						<h2 className="px-[18px] py-2 text-sm font-bold uppercase text-slate-500 dark:text-slate-400">
