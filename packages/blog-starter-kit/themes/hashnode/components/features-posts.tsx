...
const FeaturedPosts = (props: {
	...
	return (
		<div className="blog-featured-area mx-auto max-w-4xl border-b bg-slate-50 dark:border-slate-800 dark:bg-black md:grid-flow-col md:grid-cols-2 md:grid-rows-2">
			...
			<div className="blog-featured-container container mx-auto grid grid-cols-1 gap-8 px-4 py-4">
					...
					return (
						...
						>
							<Link
								...
								className="blog-article-card-cover my-5  block w-full overflow-hidden rounded-3xl border bg-slate-100 hover:opacity-90 dark:border-slate-800 dark:bg-slate-800"
							>
								<CustomImage
